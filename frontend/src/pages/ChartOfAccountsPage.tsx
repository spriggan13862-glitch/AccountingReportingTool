          ...
          <div className="flex items-center gap-0.5 min-h-[24px]">
            ...
            {hasChildren ? (
              <button
                ...
                className="w-5 h-5 flex items-center justify-center text-slate-400 hover:text-indigo-600 hover:bg-slate-100 rounded transition-colors flex-shrink-0 cursor-pointer"
              >
      ...
      >
        ...
        <div className="flex items-center justify-end gap-2 border-t border-gray-100 pt-3">
          ...
          <button
            ...
            className="px-4 py-2 text-xs bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 font-semibold cursor-pointer"

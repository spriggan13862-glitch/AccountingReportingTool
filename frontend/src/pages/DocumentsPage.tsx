...
function StatusBadge({ status }: { status: string }) {
  const map: Record<string, { label: string; cls: string }> = {
    ...
    'ready for review': { label: 'Ready for Review', cls: 'bg-indigo-50 border-indigo-250 text-indigo-800' },
    'ready_to_post': { label: 'Ready for Review', cls: 'bg-indigo-50 border-indigo-250 text-indigo-800' },
